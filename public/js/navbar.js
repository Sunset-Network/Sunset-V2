document.addEventListener('DOMContentLoaded', function() {
    ...
    // Insert the navigation HTML into the nav element
    ...
    if (navElement) {
        ...
        function setupNavigation() {
            ...
            // Highlight the "Home" link initially
            ...
            items.forEach(function(item) {
                item.addEventListener('click', function(event) {
                    ...
                    fetch(targetUrl)
                        ...
                        .then(html => {
                            // Update content area with loaded content
                            document.getElementById('content').innerHTML = html;

                            // Move the marker to the clicked item
                            moveMarker(item);
                        })
        ...
        // Call the function to setup navigation after HTML insertion
        setupNavigation();
    } else {
...
const allowedKeys = {
  ...
  function dingus() {
    console.log('meow :3')
    document.body.style.backgroundImage = "url('/backgrounds/dingusbackground.webp')";
...
async function loadsettinglang() {
  ...
  const Lang = await fetch('/languages/' + selectedLang + '.json' );
  const data = await Lang.json();
  const setcolors = document.getElementById('setColors')
  ...
  document.getElementById('customizationDescriptionb').innerText = data["boxdesc"]
  document.getElementById('cfmbtn').innerText = data["confirm"]
  document.getElementById('backgroundImage').innerText = data["backgroundImage"]
  document.getElementById('backgroundImageDescription').innerText = data["backgroundImageDescription"]
  document.getElementById('rstbtn').innerText = data["reset"]
  document.getElementById('customizationDescription').innerText = data["customizationDescription"]
  document.getElementById('setColors').innerText = data["setColors"]
  document.getElementById('themes').innerText = data["themes"]
  document.getElementById('themesDescription').innerText = data["themesDescription"]
  ...
  document.getElementById('textColorDescription').innerText = data["textColorDescription"]
  ...
  document.getElementById('languageSelector').innerText = data["languageSelector"]
  document.getElementById('languageSelectorDescription').innerText = data["languageSelectorDescription"]
  ...
  document.getElementById('cloakDescription').innerText = data["cloakDescription"]
  document.getElementById('setPanicHotkey').innerText = data["setPanicHotkey"]
  document.getElementById('panicDescription').innerText = data["panicDescription"]
  document.getElementById('searchEngine').innerText = data["searchEngine"]
  document.getElementById('searchEngineDescription').innerText = data["searchEngineDescription"]
  ...
  document.getElementById('toggleTabsDescription').innerText = data["toggleTabsDescription"]
  ...
  document.getElementById('backgroundColorb').innerHTML = `${data["box1"]} <br><input id="1" class="clrs-select" type="color">`
  document.getElementById('navbarColorb').innerHTML = `${data["box2"]} <br><input id="2" class="clrs-select" type="color">`
  document.getElementById('hoverPrimaryColorb').innerHTML = `${data["box3"]} <br><input id="3" class="clrs-select" type="color"></input>`
  document.getElementById('hoverSecondaryColorb').innerHTML = `${data["box4"]} <br><input id="4" class="clrs-select" type="color">`
  document.getElementById('hoverSecondaryColorbb').innerHTML = `${data["box5"]} <br><input id="5" class="clrs-select" type="color">`
  document.getElementById('hoverSecondaryColorrbb').innerHTML = `${data["box6"]} <br><input id="6" class="clrs-select" type="color">`
  document.getElementById('textColor').innerHTML = `${data["textColor"]} <br><input id="txt" class="clrs-select" type="color">`
  document.getElementById('hoverSecondaryColor').innerHTML = `${data["hoverSecondaryColor"]} <br><input id="hsc" class="clrs-select" type="color">`
  document.getElementById('hoverPrimaryColor').innerHTML = `${data["hoverPrimaryColor"]} <br><input id="set" class="clrs-select" type="color">`
  document.getElementById('navbarColor').innerHTML = `${data["navbarColor"]} <br><input id="navc" class="clrs-select" type="color">`
  document.getElementById('backgroundColor').innerHTML = `${data["backgroundColor"]} <br><input id="bc" class="clrs-select" type="color">`
}
